...
public class DirectoryCorpus implements DocumentCorpus {
	 ...
	 * Before calling GetDocuments(), you must register a FileDocumentFactory with
	 * the RegisterFileDocumentFactory
	 * method. Otherwise, the corpus will not know what to do with the files it
	 * finds. The LoadTextDirectory facade
	 ...
	 * By default, a corpus
	 * does not know how to load any files -- this method must be called prior to
	 * getDocuments().
	 */
